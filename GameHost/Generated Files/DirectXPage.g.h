...
struct WINRT_EBO DirectXPage_base : implements<D, GameHost::IDirectXPage, Windows::UI::Xaml::Controls::IControlOverrides, Windows::UI::Xaml::Controls::IControlOverrides6, Windows::UI::Xaml::Controls::IPageOverrides, Windows::UI::Xaml::IFrameworkElementOverrides, Windows::UI::Xaml::IFrameworkElementOverrides2, Windows::UI::Xaml::IUIElementOverrides, Windows::UI::Xaml::IUIElementOverrides7, Windows::UI::Xaml::IUIElementOverrides8, Windows::UI::Xaml::IUIElementOverrides9, composing, I...>,
...
{
    using base_type = DirectXPage_base;
    using class_type = GameHost::DirectXPage;
    using implements_type = typename DirectXPage_base::implements_type;
...
struct WINRT_EBO DirectXPageT : implements<D, Windows::Foundation::IActivationFactory, I...>
{
    using instance_type = GameHost::DirectXPage;
...
#if defined(WINRT_FORCE_INCLUDE_DIRECTXPAGE_XAML_G_H) || __has_include("DirectXPage.xaml.g.h")

#include "DirectXPage.xaml.g.h"
...
{
    template <typename D, typename... I>
    using DirectXPageT = DirectXPage_base<D, I...>;
}
